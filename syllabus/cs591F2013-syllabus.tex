...
\begin{quote}
	...
	class session per week. Prerequisites: Permission of the instructor. {\em Two credit group study}.
...
late deadline. In addition to submitting the required deliverables for an assignment completed in a group, students must
turn in a one-page document that describes each group member's contribution to the submitted deliverables.  
