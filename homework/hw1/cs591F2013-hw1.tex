...
at least one extension to this widget.  Once you have finished installing and customizing DashClock, try to use the
Power Toggles to create a toggle panel in the notification panel.  For example, you may want to add toggles for the
